 ...
 * Practica 7: Paginación Simple
 * Continuacion de la practica 5
 * Se agrego una tabla de memoria donde ahora el limite de procesos se mostrara en ella ya sea bloqueados, listos o en ejecucion.
 */
public class SimulacionProcesos {
	...
	public Proceso nuevoProceso(int numeroID){
		...
		nuevoProc.setTiempo((int) (Math.random() * 12 + 1));
